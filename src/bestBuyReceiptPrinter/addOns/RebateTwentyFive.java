...
public class RebateTwentyFive implements Rebate {
	 ...
	 * Default Constructor
	 */
	public RebateTwentyFive()
	{
		this.amountOff=new BigDecimal(25.00);
	...
	{
		String rebateText="$"+this.amountOff.toString()+" REBATE (#25)";
		return rebateText;
	}
